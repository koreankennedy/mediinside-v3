...
export const mockRecruitmentActivity = {
  ...
  recentActivity: [
    { type: 'offer_sent', message: '청담리더스피부과에서 회원님께 관심을 표시했어요', time: '3분 전' },
    { type: 'job_posted', message: '압구정미래성형외과에서 새 공고를 등록했어요', time: '10분 전' },
    { type: 'interview', message: '오늘 면접 예정인 후보자가 있어요', time: '30분 전' },
    { type: 'offer_accepted', message: '회원님과 비슷한 조건의 매칭이 성사됐어요', time: '1시간 전' },
  ],
};
