...
export const mockJobPostings = [
  {
    ...
    views: 245,
    aiRecommended: 8,
    hiringProducts: ['revenueShare', 'loyaltyBonus'],
    insight: '급여 범위를 +10% 높이면 지원율 25% 증가 예상',
    createdAt: new Date('2024-12-01'),
  ...
  },
  {
    ...
    salaryRange: '300~350만원',
    workType: '정규직',
    workHours: '09:00~18:00',
    benefits: ['4대보험', '교육 지원', '점심제공'],
    requirements: ['간호조무사 면허', '성실하고 배우려는 자세'],
    status: 'pending',
    applicants: 5,
    views: 89,
    aiRecommended: 3,
    hiringProducts: ['signingBonus'],
    insight: '마감 7일 전! 사이닝 보너스 추가 시 지원율 40% 증가 예상',
    createdAt: new Date('2024-12-10'),
...
export const mockNewMatchingCandidates = [
  ...
  // === 채용절차 진행중 8명 ===
  {
    ...
    fitType: 'high_end_achiever',
    fitTypeLabel: '하이엔드 성과자',
    skills: ['전문시술', '팀매니징', '고객상담'],
    preferredIntensity: 'high' as const,
    preferredProducts: ['share', 'allowance'],
    hasColleagueFit: true,
    status: 'negotiating' as const,
    profileImage: null,
    statusDetail: '급여 협상 중 (4,200만원 요청)',
  },
  {
    id: 'progress-candidate-2',
    name: '최수민',
    licenseType: '간호사',
    experience: '4년',
    matchScore: 90,
    ...
    profileImage: null,
    statusDetail: '대면면접 예정 (내일 오후 2시)',
  },
  {
    id: 'progress-candidate-3',
    name: '정민지',
    licenseType: '간호사',
    experience: '3년',
    matchScore: 88,
    ...
    profileImage: null,
    statusDetail: 'AI인터뷰 완료 (89점)',
  },
  {
    id: 'progress-candidate-4',
    name: '강은비',
    licenseType: '간호조무사',
    experience: '2년',
    matchScore: 85,
    ...
    status: 'ai_interview' as const,
    profileImage: null,
    statusDetail: 'AI인터뷰 진행 중',
  },
  {
    id: 'progress-candidate-5',
    name: '이은정',
    licenseType: '간호사',
    experience: '3년',
    matchScore: 92,
    ...
    status: 'negotiating' as const,
    profileImage: null,
    statusDetail: '오퍼 응답 대기 중',
  },
  {
    id: 'progress-candidate-6',
    name: '박수진',
    licenseType: '간호사',
    experience: '5년',
    matchScore: 89,
    ...
    status: 'interview_scheduled' as const,
    profileImage: null,
    statusDetail: '대면면접 완료 (결과 검토 중)',
  },
  {
    id: 'progress-candidate-7',
    name: '임수정',
    licenseType: '간호사',
    experience: '3년',
    matchScore: 91,
    ...
    status: 'ai_interview' as const,
    profileImage: null,
    statusDetail: 'AI인터뷰 완료 (92점)',
  },
  {
    id: 'progress-candidate-8',
    name: '한지원',
    licenseType: '간호사',
    experience: '4년',
    matchScore: 78,
